...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        buildDateDeleteInfo->setObjectName("buildDateDeleteInfo");
        ...
        lastUpdateDeleteInfo->setObjectName("lastUpdateDeleteInfo");
        ...
        daysSinceLastUpdateDeleteInfo->setObjectName("daysSinceLastUpdateDeleteInfo");
